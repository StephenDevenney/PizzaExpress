...
export class AuthService {
    ...
    public async revertSettings(): Promise<void> {
        ...
        this.globals.currentPage = this.globals.config.defaultPage;
        this.globals.previousPage = this.globals.config.defaultPage;
        this.globals.client.token = "";
        this.globals.client.isAuthenticated = false;
